...
* https://assets.confluent.io/m/2d7c883a8aa6a71d/original/20200501-WP-Benchmark_Your_Dedicated_Apache_Kafka_Cluster_on_Confluent_Cloud.pdf[Benchmark Your Dedicated Apache Kafka® Cluster on Confluent Cloud]
...
* https://assets.confluent.io/m/7e6a01e527df1110/original/20170608-WP-Microservices_in_the_Apache_Kafka_Ecosystem-EN.pdf[Microservices in the Apache Kafka Ecosystem ]
